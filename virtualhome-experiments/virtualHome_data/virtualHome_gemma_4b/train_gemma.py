...
def main(
    ...
    dataset: str = "virtualHome",  # used to pick function dictionary
    input_file: str = "virtualHome_gemma-3-4b-pt.json",  # list of examples with fields: text, tar_eq, (optional) start_token_idx/end_token_idx
    lr: float = 1e-3,
    num_epochs: int = 3,
    ...
    func_dict_path = f"{dataset}_func_dict.json"
