...
def load_func_dict(dataset: str) -> Dict[str, int]:
    path = f"data/{dataset}_func_dict.json"
...
def main(
    ...
    output_name: str = "inference-llama-3.2-3b-func-4b.jsonl",
    func_head_path: Optional[str] = None, #"checkpoints_head_only/head_best.pth", #None
    max_func_calls: int = 16,
    op_arg_retry_limit: int = 1,
